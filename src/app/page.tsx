      ...
      <Container className="mt-16">
        <div className="lg:flex lg:items-center lg:justify-end">
          ...
          <List className="mt-16 lg:mt-0 lg:w-1/2 lg:min-w-132 lg:pl-4">
            <ListItem title="WORKING AT HEIGHTS">
              The purpose of working at heights infrastructure is to provide a
              safe and secure environment for workers while they perform at
              elevated positions.
            </ListItem>
            <ListItem title="FALL PROTECTION">
              Fall protection height safety systems provide a crucial layer of
              protection and Karabiner are leaders in determining these
              requirements.
            </ListItem>
            ...
            <ListItem title="MAINTENANCE">
              These systems play a critical role in maintaining the aesthetics,
